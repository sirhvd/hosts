<?php 
	...
	$lists = array(
		// Base Ads
		'AdGuardBase' => 'https://filters.adtidy.org/android/filters/2_optimized.txt',

		// Mobile Ads
		'AdGuardMobileAds' => 'https://filters.adtidy.org/android/filters/11_optimized.txt',
		...
		// Adguard Tracking
		'AdguardTracking' => 'https://filters.adtidy.org/android/filters/3_optimized.txt',
		...
		// ABPVN
		'ABPVN' => 'https://abpvn.com/filter/abpvn-KoE1Dm.txt'
	);
	...
	foreach ( $lists as $name => $list ) {
		...
		// Output the file.
		file_put_contents( "filters/{$name}.txt", $hosts );
